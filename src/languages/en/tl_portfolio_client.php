...
$GLOBALS['TL_LANG']['tl_portfolio_client']['logo_legend']        = 'Logo settings';
$GLOBALS['TL_LANG']['tl_portfolio_client']['website_legend']     = 'Website';
 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_portfolio_client']['new']    = array('Add client', 'Add a new client');
